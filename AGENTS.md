...
### 1. Rename ALL instances of template name to your OS name

**Source of truth**: `Containerfile` line 4: `# Name: ultos`
...
**Template Version**: ultos (Based on finpilot template with comprehensive Copilot instructions)  
